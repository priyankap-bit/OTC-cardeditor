...
export const Card: ComponentConfig<CardProps> = {
  ...
  //   mode: "flat",
  // },
  render: ({ title, icon, description, mode, Name, Company, Designation, Cover }) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch("https://dfdp7k-8080.csb.app/getUser");
    ...
    Card.defaultProps = {
      ...
      Name: userData[0].first_name
            ...
            : "Name",
      Company: userData[0].companyID && userData[0].companyID.$oid
            ? userData[0].companyID.$oid : "Company Name",
      Designation: userData[0].user_id && userData[0].user_id.designation
            ? userData[0].user_id.designation.join(" | ") : "Designation",
      title: "Title",
      description: "Description",
      icon: "Feather",
      mode: "flat",
